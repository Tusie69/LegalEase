...
<section class="relative -mt-18 flex min-h-screen flex-col lg:landscape:flex-row">
    ...
    <div class="flex flex-1 items-center justify-center px-6 py-16 md:py-20">
        <div class="w-full max-w-[440px]">
            <h1 class="text-flow-h1">Đăng ký tham gia</h1>
            ...
            <form method="POST" action="{{ route('lawyer.register.store') }}" class="mt-8 space-y-5" novalidate
                ...
                <div>
                    <label for="bar_association_choice" class="block text-form-label">
                    ...
                    <input x-show="barAssocChoice === '__other__'"
                           ...
                           class="mt-3 block w-full rounded-xl border border-text/20 bg-bg px-4 py-3 text-body text-text focus:border-accent focus:outline-none focus:ring-1 focus:ring-accent">
                    ...
                    @unless ($errors->has('bar_association'))
                        <p x-show="barAssocError" x-cloak x-text="barAssocError" class="mt-2 text-caption text-error"></p>
                    @endunless
                    @error('bar_association') <p class="mt-2 text-caption text-error">{{ $message }}</p> @enderror
                </div>

                <div>
                    <label for="bar_card_number" class="block text-form-label">
                    ...
                    @unless ($errors->has('bar_card_number'))
                        <p x-show="barCardError" x-cloak x-text="barCardError" class="mt-2 text-caption text-error"></p>
                    @endunless
                    @error('bar_card_number') <p class="mt-2 text-caption text-error">{{ $message }}</p> @enderror
                </div>
