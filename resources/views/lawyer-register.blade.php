...
<section class="relative -mt-[72px] flex min-h-screen flex-col md:flex-row">
    ...
    <div class="flex flex-1 items-center justify-center px-6 py-16 md:py-20">
        <div class="w-full max-w-[440px]">
            ...
            <h1 class="mt-3 font-display text-[36px] font-medium tracking-[-0.02em] md:text-[44px]">Apply to join</h1>
            ...
            <form method="POST" action="{{ route('lawyer.register.store') }}" class="mt-8 space-y-5" novalidate
                ...
                <div>
                    ...
                    <div class="relative mt-2">
                        <select id="bar_association" name="bar_association" x-model="barAssoc" @blur="touched.barAssoc = true" required
                            ...
                            <option value="Hanoi Bar Association">Hanoi Bar Association</option>
                            <option value="Ho Chi Minh City Bar Association">Ho Chi Minh City Bar Association</option>
                        </select>
                ...
                <div>
                    <label class="flex items-start gap-2 text-[13px] text-muted">
                        ...
                        <span>
                            I agree to the
                            <a href="{{ route('terms') }}" class="text-text transition-colors hover:text-accent">Terms of Service</a>
                            and
                            <a href="{{ route('privacy') }}" class="text-text transition-colors hover:text-accent">Privacy Policy</a>.
    ...
    function lawyerSignupValidation(initial) {
        return {
            ...
            get barAssocError() {
                ...
                return 'Please select your bar association.';
            },
            get barCardError() {
