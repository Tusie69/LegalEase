@extends('layouts.app', ['title' => 'Lawyer sign in · LegalEase'])
...
<section class="relative -mt-[72px] flex min-h-screen flex-col md:flex-row">
    ...
    <div class="flex flex-1 items-center justify-center px-6 py-16 md:py-20">
        <div class="w-full max-w-[440px]">
            ...
            <form method="POST" action="#" class="mt-8 space-y-5" novalidate>
                @csrf
                ...
                <p class="text-center text-[14px] text-muted">
                    ...
                    <a href="{{ route('lawyer.register') }}" class="text-text transition-colors hover:text-accent">Apply to join</a>
                </p>
            </form>
        </div>
    </div>
