...
<section class="relative -mt-[72px] flex min-h-screen flex-col md:flex-row">
    ...
    <div class="flex flex-1 items-center justify-center px-6 py-16 md:py-20">
        <div class="w-full max-w-[440px]">
            ...
            <h1 class="mt-3 font-display text-[36px] font-medium tracking-[-0.02em] md:text-[44px]">Đăng nhập</h1>
            <p class="mt-2 text-[15px] text-secondary">Quản lý lịch hẹn và trạng thái hồ sơ của bạn.</p>
