                ...
                <form method="POST" action="{{ route('register.store') }}" novalidate>
                    ...
                    <fieldset class="field {{ $errors->has('password') ? 'error' : '' }}">
                        ...
                        <div class="password-wrap">
                            ...
                            <button type="button" data-toggle-password="#register-password" aria-label="Ẩn hoặc hiện mật khẩu">&#128065;</button>
                        </div>
                    </fieldset>
                    @error('password')
                        <p class="error-text">{{ $message }}</p>
                    ...
                    <fieldset class="field">
                        ...
                        <div class="password-wrap">
                            ...
                            <button type="button" data-toggle-password="#register-password-confirmation" aria-label="Ẩn hoặc hiện xác nhận mật khẩu">&#128065;</button>
                        </div>
                    </fieldset>
                    ...
                    <div class="meta-row" style="justify-content:flex-start;">
                        <label class="checkbox">
                            ...
                            <span>Tôi đồng ý với <a class="link-accent" href="#">Điều khoản</a> và <a class="link-accent" href="#">chính sách bảo mật</a></span>
                        </label>
                    </div>
