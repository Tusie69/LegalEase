    ...
    <div class="flex flex-1 items-center justify-center px-6 py-16 md:py-20">
        <div class="w-full max-w-[440px]">
            ...
            <form method="POST" action="{{ route('register.store') }}" class="mt-8 space-y-5" novalidate>
                ...
                <div class="grid gap-5 md:grid-cols-2">
                    <div>
                        <label for="date_of_birth" class="block text-[13px] font-medium text-muted">Date of birth</label>
                    ...
                    <div>
                        <label for="gender" class="block text-[13px] font-medium text-muted">Gender</label>
                ...
                <label class="flex items-start gap-2 text-[13px] text-muted">
                    <input type="checkbox" class="mt-0.5 h-4 w-4 rounded border-text/20 bg-surface text-accent focus:ring-accent">
