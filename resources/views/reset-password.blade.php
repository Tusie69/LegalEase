...
<section class="relative -mt-18 flex min-h-screen flex-col lg:landscape:flex-row">
    ...
    <div class="flex flex-1 items-center justify-center px-6 py-16 md:py-20">
        <div class="w-full max-w-[440px]">
            ...
            <p class="text-body mt-2">Chọn một mật khẩu bạn không sử dụng ở bất kỳ nơi nào khác. Bạn sẽ đăng nhập sau khi nó được lưu.</p>
    ...
    function resetPasswordValidation(initial) {
        return {
            ...
            get passwordError() {
                ...
                if (this.password.length < 8) return 'Tối thiểu 8 ký tự.';
