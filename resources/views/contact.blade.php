...
@section('content')
    ...
    <section class="mx-auto max-w-[1280px] px-8 pt-24 pb-24">
        <div class="max-w-[720px]">
            ...
            <p class="mt-6 max-w-[600px] text-[18px] leading-relaxed text-secondary">
                Dù bạn có câu hỏi về nền tảng, đề xuất hợp tác hay phản hồi cần chia sẻ, chúng tôi đều đọc từng tin nhắn.
            </p>
        </div>
            ...
            <div class="space-y-10">
                ...
                <div>
                    ...
                    <ul class="mt-3 space-y-1 text-[15px] text-text">
                        <li>Liên hệ chung: <a href="mailto:hello@legalease.vn" class="transition-colors hover:text-accent">hello@legalease.vn</a></li>
                        <li>Hồ sơ luật sư: <a href="mailto:lawyers@legalease.vn" class="transition-colors hover:text-accent">lawyers@legalease.vn</a></li>
                    </ul>
                </div>

                {{-- Phone --}}
                <div>
                    <p class="text-[12px] font-medium uppercase tracking-[0.1em] text-muted">Điện thoại</p>
                    <ul class="mt-3 space-y-1 text-[15px] text-text">
                        <li>Hỗ trợ khách hàng: <a href="tel:+842473001234" class="transition-colors hover:text-accent">+84 24 7300 1234</a></li>
                        <li class="text-muted">Giờ làm việc: Thứ Hai đến Thứ Sáu, 9:00 đến 18:00 ICT</li>
                    </ul>
                </div>

                {{-- Office --}}
                <div>
                    <p class="text-[12px] font-medium uppercase tracking-[0.1em] text-muted">Văn phòng</p>
                    <div class="mt-3 overflow-hidden rounded-xl border border-text/10">
                        <iframe
                            ...
                            loading="lazy"
                            title="Bản đồ văn phòng LegalEase tại 109 Trần Hưng Đạo, Hoàn Kiếm, Hà Nội"></iframe>
                    </div>
            ...
            <div>
                <form x-data='{
                    ...
                    <div class="mt-6 flex flex-1 flex-col gap-5">
                        <div>
                            <label for="name" class="mb-2 block text-[14px] text-muted">Tên của bạn</label>
                        ...
                        <div>
                            <label for="email" class="mb-2 block text-[14px] text-muted">Địa chỉ email</label>
                        ...
                        <div class="flex min-h-0 flex-1 flex-col">
                            <label for="message" class="mb-2 block text-[14px] text-muted">Tin nhắn của bạn</label>
                        ...
                        <p x-show="submitted" x-cloak
                           class="text-[14px] text-success">
                            Cảm ơn bạn. Chúng tôi sẽ liên hệ lại trong 1 đến 2 ngày làm việc.
                        </p>
                    </div>
                </form>
            </div>
    ...
    <section class="mx-auto max-w-[1280px] px-8 pt-32 pb-24 text-center">
        <p class="text-[14px] text-muted">
            Mọi tin nhắn đều được người thật đọc và chúng tôi cố gắng phản hồi trong một ngày làm việc.
        </p>
    </section>
@endsection
