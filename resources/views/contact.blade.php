...
@section('content')
    ...
    <section class="mx-auto max-w-[1280px] px-8 pt-24 pb-24">
        ...
        <div class="mt-16 grid gap-16 md:grid-cols-[5fr_7fr]">
            ...
            <div>
                <form x-data='{
                    ...
                    <div class="mt-6 flex flex-1 flex-col gap-5">
                        <div>
                            <label for="name" class="mb-2 block text-[14px] text-muted">Họ và tên</label>
                        ...
                        <div>
                            <label for="subject" class="mb-2 block text-[14px] text-muted">Chủ đề</label>
                            <div class="relative">
                        ...
                        <div class="flex min-h-0 flex-1 flex-col">
                            <label for="message" class="mb-2 block text-[14px] text-muted">Tin nhắn</label>
