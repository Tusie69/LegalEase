@extends('layouts.app', ['title' => 'Terms of Service · LegalEase'])
...
@php
    ...
    $sections = [
        ...
        [
            ...
            'title' => 'Contact',
            'paras' => [
                'Questions about these terms? Email <a href="mailto:legal@legalease.vn" class="text-text underline underline-offset-4 decoration-muted/60 transition-colors hover:decoration-accent">legal@legalease.vn</a> or use the <a href="' . route('contact') . '" class="text-text underline underline-offset-4 decoration-muted/60 transition-colors hover:decoration-accent">contact page</a>.',
            ],
        ],
    ];
@endphp
